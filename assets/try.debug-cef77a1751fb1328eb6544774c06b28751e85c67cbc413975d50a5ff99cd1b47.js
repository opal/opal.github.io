...
;if (typeof(OpalLoaded) === 'undefined') OpalLoaded = []; OpalLoaded.push("_vendor/codemirror");CodeMirror.defineMode("ruby", function(config, parserConfig) {
...
;if (typeof(OpalLoaded) === 'undefined') OpalLoaded = []; OpalLoaded.push("_vendor/ruby");CodeMirror.defineMode("javascript", function(config, parserConfig) {
  ...
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$setup_links', function $$setup_links() {
      ...
      return $send($$('TRY_EXAMPLES'), 'each', [], function $$5(title, code){var self = $$5.$$s == null ? this : $$5.$$s, url = nil, link = nil, spacer = nil;
        ...
        spacer = $gvars.$['$[]']("document").$createTextNode("   ");
...
//# sourceMappingURL=try.js-36d36de92b76b5bc6a78fe881a1f35f21850e16012f651ffd463a5e470044bb1.map
